...
features = scouts.drop(columns = ['atleta_id','preco_num', 'variacao_num'])
...
aux = scouts.drop(columns = ['atleta_id','preco_num', 'variacao_num'])
...
scouts2015 = scouts2015.drop(columns = ['atleta_id', 'rodada','clube_id','jogos_num','pontos_num','media_num','preco_num'])
variancia2015 = scouts2015.variacao_num
z = np.column_stack((scouts2015.FS, scouts2015.PE, scouts2015.FF, scouts2015.PP, scouts2015.RB, scouts2015.FC, scouts2015.CA, scouts2015.CV,
...
print("RF = ", modelo.score(z,variancia2015))